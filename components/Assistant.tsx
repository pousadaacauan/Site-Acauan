  ...
  return (
    <div className="fixed bottom-8 right-8 z-50 flex flex-col items-end font-sans">
        ...
        <div className="bg-[#F5F2EB] rounded-none shadow-2xl shadow-[#2C2A26]/10 w-[90vw] sm:w-[380px] h-[550px] mb-6 flex flex-col overflow-hidden border border-[#D6D1C7] animate-slide-up-fade">
          ...
          <div className="bg-[#EBE7DE] p-5 border-b border-[#D6D1C7] flex justify-between items-center">
            <div className="flex items-center gap-3">
                ...
                <span className="font-serif italic text-[#2C2A26] text-lg">Gaya</span>
            </div>
            <button onClick={() => setIsOpen(false)} className="text-[#A8A29E] hover:text-[#7895B2] transition-colors">
            ...
            {isThinking && (
               <div className="flex justify-start">
                 <div className="bg-white border border-[#EBE7DE] p-5 flex gap-1 items-center shadow-sm">
                   <div className="w-1.5 h-1.5 bg-[#7895B2] rounded-full animate-bounce"></div>
                   <div className="w-1.5 h-1.5 bg-[#7895B2] rounded-full animate-bounce delay-75"></div>
                   <div className="w-1.5 h-1.5 bg-[#7895B2] rounded-full animate-bounce delay-150"></div>
                 </div>
               </div>
            )}
          </div>
          ...
          <div className="p-5 bg-[#F5F2EB] border-t border-[#D6D1C7]">
            <div className="flex gap-2 relative">
              ...
              <button 
                ...
                className="bg-[#7895B2] text-white px-4 hover:bg-[#5D7A94] transition-colors disabled:opacity-50"
              >
      ...
      <button 
        ...
        className="bg-[#7895B2] text-white w-14 h-14 flex items-center justify-center rounded-full shadow-xl hover:scale-105 transition-all duration-500 z-50"
      >
        {isOpen ? (
             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-6 h-6">
            ...
            <span className="font-serif italic text-lg">Gaya</span>
        )}
      </button>
    </div>
  );
